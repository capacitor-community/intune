...
public final class MSALUtil {
    ...
    public static void acquireTokenSilent(
        ...
        if (account == null) {
            ...
            callback.onError(new MsalUiRequiredException(MsalUiRequiredException.NO_ACCOUNT_FOUND, "no account found for " + aadId));
            return;
        }
    ...
    public static void signOutAccount(@NonNull final Context appContext, @NonNull final String aadId)
        ...
        if (mMsalClientApplication instanceof IMultipleAccountPublicClientApplication) {
            IMultipleAccountPublicClientApplication multiAccountPCA = (IMultipleAccountPublicClientApplication) mMsalClientApplication;

            multiAccountPCA.removeAccount(account);
        } else {
            ISingleAccountPublicClientApplication singleAccountPCA = (ISingleAccountPublicClientApplication) mMsalClientApplication;
    ...
    private static synchronized void initializeMsalClientApplication(final Context appContext) throws MsalException, InterruptedException {
